...
export default function AuthLayout() {
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B1120] flex">
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary via-primary-dark to-violet-800 items-center justify-center p-12">
        ...
        <div className="relative z-10 text-center max-w-md">
          ...
          <div className="grid grid-cols-3 gap-5" style={{ marginTop: '48px' }}>
            {['10K+', '500+', '4.9'].map((stat, i) => (
              <div key={i} className="bg-white/10 backdrop-blur-sm rounded-2xl border border-white/10 p-4">
