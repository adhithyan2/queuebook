  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-zinc-500 dark:text-zinc-400 mt-1 text-sm">Sign in to your QueueBook account</p>
      </div>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-zinc-50 dark:bg-[#09090b] px-3 text-zinc-400">or continue with</span>
        </div>
      </div>
