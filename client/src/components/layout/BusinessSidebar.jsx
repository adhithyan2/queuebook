...
import {
  ...
  HiOutlineStar, HiOutlineUser,
  HiOutlineLogout, HiOutlineX, HiOutlineChatAlt2
} from 'react-icons/hi';
  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="px-3 pb-4 pt-3 border-t border-zinc-100 dark:border-zinc-800">
        <Link to="/business/profile" className="flex items-center gap-2.5 px-2.5 py-2 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800/60 transition-colors">
