  ...
  const sidebarContent = (
    <div className="flex flex-col h-full">
      ...
      <div className="px-4 pb-5 pt-4 border-t border-slate-100 dark:border-slate-700">
        <Link to="/customer/profile" className="flex items-center gap-3 px-3 py-3 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700/50 transition-all duration-200">
